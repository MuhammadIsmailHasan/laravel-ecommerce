...
class FrontController extends Controller
{
    ...
    public function product() 
    {
        ...
        // KAN MENGIRIM JUGA DATA CATEGORI, DG VIEW COMPOSER
        return view($this->path . '.product', compact('products'));
    }
    ...
    public function verifyCustomerRegistration($token)
    {
        ...
        return redirect(route('customer.login'))->with(['error', 'Gagal Verifikasi Akun']);
    }
    ...
    public function customerSettingForm()
    {
        ...
        return view($this->path . '.setting', compact('customer', 'provinces'));
    }
    ...
    public function customerUpdateProfile(Request $request)
    {
        ...
        $data = $request->only('name', 'phone', 'address', 'district_id');
        if ($request->password != '') {
        ...
        return redirect(route('customer.dashboard'))->with(['success' => 'Profil berhasil diperbaharui']);
    }
