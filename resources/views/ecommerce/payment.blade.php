@extends('layouts.frontend.ecommerce')
						...
						<div class="col-md-12">
							<div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('customer.payment_save') }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice" class="form-control" value="{{ request()->invoice }}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="transfer_to" class="form-control" required>
                                                ...
                                                <option value="BCA - 1234567">BCA: 1234567 a.n Ismail Hasan</option>
                                                <option value="Mandiri - 2345678">Mandiri: 2345678 a.n Ismail Hasan</option>
                                                <option value="BRI - 9876543">BRI: 9876543 a.n Ismail Hasan</option>
                                                <option value="BNI - 6789456">BNI: 6789456 a.n Ismail Hasan</option>
                                            </select>
