...
@section('title')
    <title>Keranjang Belanja - Ismail Ecommerce</title>
@endsection
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div class="product_count">
                                                    ...
                                                    <!-- NAMENYA KITA GUNAKAN ARRAY AGAR BISA MENYIMPAN LEBIH DARI 1 DATA -->
                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner">
                                        ...
                                        <a class="main_btn" href="{{ route('front.checkout_cart') }}">Proceed to checkout</a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
