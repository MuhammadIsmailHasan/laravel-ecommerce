...
@section('title')
    <title>Pengaturan - Ismail Ecommerce</title>
@endsection
		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
                        <a href="{{ url('/') }}">Home</a>
                        <a href="{{ route('customer.setting_form') }}">Pengaturan</a>
					</div>
				</div>
			</div>
		</div>
                    ...
                    <div class="row">
						<div class="col-md-12">
							<div class="card">
                                ...
                                <div class="card-body">
                                    @include('layouts.module.session')
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response.data, function (i, v) { 
                        ...
                        let selected = type == 'bySelect' && citySelected == v.id ? 'selected' : '';
                        $('#city_id').append(`
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.data, function (i, v) { 
                    ...
                    let selected = type == 'bySelect' && districtSelected == v.id ? 'selected' : '';
                    $('#district_id').append(`
                        <option value="${v.id}" ${selected}>
                            ${v.name}
                        </option>
