                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand" href="{{ url('/') }}">
                            <h1 class="navbar-brand-full text-uppercase font-weight-bold ">Ismail-EC</h1>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <p>Ikuti untuk update tren kami</p>
                            <div id="mc_embed_signup">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget f_social_wd">
                            ...
                            <p>Berminat ngobrol santai di sosial media</p>
                            <div class="f_social">
                                <a href="https://www.linkedin.com/in/muhammad-ismail-hasan-147475156/">
                                    <i class="fa fa-linkedin"></i>
                                </a>
                                <a href="https://github.com/MuhammadIsmailHasan">
