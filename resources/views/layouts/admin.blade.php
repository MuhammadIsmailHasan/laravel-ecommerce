...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Ismail - Aplikasi Ecommerce">
        <meta name="author" content="Ismail Hasan">
    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
        ...
        <footer class="app-footer">
            <div>
                <a href="https://fortinity.net" target="_blank">Ismail Hasan</a>
                <span>&copy; 2020 fortinity.</span>
            </div>
            <div class="ml-auto">
